...
<!-- Build ID: e2c76d01a114 -->
<!-- APM Version: 0.16.0 -->
<!-- Sources: dependency:Netcracker/qubership-ai-packages/agent-packages/apm-authoring, local -->

## Files matching `**`

<!-- Source: local agent-packages/common-conventions/.apm/instructions/clarify-before-coding.instructions.md -->
...
## Files matching `**/*.{md,go,yaml,yml}`

<!-- Source: local agent-packages/go-conventions/.apm/instructions/ci-super-linter.instructions.md -->
